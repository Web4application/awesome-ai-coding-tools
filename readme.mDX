...
---
- **[toprank](https://github.com/nowork-studio/toprank)**: Open-source Claude Code plugin providing SEO and Google Ads skills for meta tag optimization, schema markup, keyword bids, and CMS content pushes.
